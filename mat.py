...
print('wiki dob length {}, imdb dob length {}'.format(len(wiki_dob), len(imdb_dob)))
...
print('wiki age length {}, imdb age length {}'.format(len(wiki_age), len(imdb_age)))
...
print('wiki df length {}, imdb df length {}'.format(final_wiki_df.shape, final_imdb_df.shape))
...
print('meta pre len {}'.format(meta.shape))
meta = meta[meta['face_score1'] != '-inf']
meta = meta[meta['face_score2'] == 'nan']
print('meta post len {}'.format(meta.shape))

meta = meta.drop(['face_score1', 'face_score2'], axis=1)
print('total length pre {}'.format(meta.shape))
meta = meta.sample(frac=1)
print('total length {}'.format(meta.shape))
meta.to_csv('meta_wiki_imdb.csv', index=False)
